...
document.addEventListener('DOMContentLoaded',()=>{
    ...
    // Replace partners logos after DOM ready to use local assets
    replacePartnersLogosWithLocal();
});
